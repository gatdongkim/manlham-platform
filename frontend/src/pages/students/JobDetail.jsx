...
import { 
  ...
  Clock, Globe, ShieldCheck, DollarSign, Briefcase 
} from 'lucide-react';
...
export default function JobDetail() {
  ...
  useEffect(() => {
    const fetchJob = async () => {
      try {
        ...
        // ✅ Robust Data Extraction: Checks multiple common API patterns
  ...
  const handleApply = async () => {
    if (!bidAmount || bidAmount <= 0) return alert("Please enter a valid bid amount.");
    try {
      setSubmitting(true);
      await api.post(`/jobs/${id}/apply`, { bidAmount });
      alert("Proposal transmitted!");
  ...
  if (loading) return (
    <div className="flex flex-col items-center justify-center min-h-[70vh]">
      ...
      <p className="text-gray-400 font-black uppercase tracking-[0.4em] text-[10px]">Syncing Project Specs</p>
    </div>
  );
  ...
  if (!job) return (
    <div className="max-w-4xl mx-auto text-center py-32 space-y-6">
      ...
      <h2 className="text-3xl font-black text-gray-900 italic tracking-tight">Opportunity Expired<span className="text-indigo-600">.</span></h2>
      <p className="text-gray-500 max-w-xs mx-auto text-sm font-medium">This listing might have been removed or the ID is incorrect.</p>
      <button 
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 pb-32 p-4">
      ...
      {/* ✅ Back Button explicitly set to Marketplace */}
        ...
        <div className="lg:col-span-8 space-y-10">
          <header className="space-y-4">
            ...
            <div className="flex flex-wrap gap-6 text-gray-400 text-[10px] font-black uppercase tracking-widest pt-4">
              <span className="flex items-center gap-2"><Clock size={16} className="text-indigo-500" /> Payment Verified</span>
              <span className="flex items-center gap-2"><ShieldCheck size={16} className="text-emerald-500" /> Escrow Protected</span>
            </div>
          </header>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-gray-900 p-10 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden group">
            <div className="relative space-y-8">
              <div>
                <span className="text-[10px] font-black uppercase text-indigo-400 tracking-[0.3em]">Project Budget</span>
              ...
              <div className="space-y-4">
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Submit Your Bid</label>
