...
export default function PostJob() {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-20 space-y-8">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-2xl shadow-indigo-100/20 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <select 
                className="w-full pl-14 pr-6 py-5 bg-gray-50 border-none rounded-2xl font-black italic outline-none appearance-none focus:ring-4 focus:ring-indigo-500/10"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <select 
                className="w-28 bg-gray-900 text-white rounded-2xl font-black text-xs p-5 outline-none"
        ...
        <button 
          ...
          className="w-full bg-gray-900 text-white py-6 rounded-[2rem] font-black uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 hover:bg-indigo-600 transition-all shadow-xl shadow-gray-200 active:scale-95 disabled:opacity-50"
        >
          {loading ? <Loader2 className="animate-spin" /> : <><Send size={18} /> Publish Opportunity</>}
        </button>
      </form>
    </div>
  );
